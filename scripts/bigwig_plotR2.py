...
# Input **R2** BigWigs — update paths if needed
bigwigs = {
    "p65": [
...
plt.title("PRO-seq R2 Signal Across Plasmid Cassette", fontsize=14, fontweight='bold')
...
# Layout and save
plt.tight_layout()
plt.savefig("plasmid_cassette_R2_signal.png", dpi=300, bbox_inches='tight')


print("✅ Plot saved as plasmid_cassette_R2_signal.png")
